...
Swap.prototype.act = function(step){
	this.wobble += step * wobbleSpeed;
	var wobblePos = Math.sin(this.wobble) * (wobbleDist * 3);
...
Player.prototype.moveY = function(step, level, keys) {
  ...
  if(obstacle){
	  ...
	  if(obstacle != "floater"){
		...
		else if(keys.up && this.speed.y < 0 && gravitySwitched)
		{
			this.speed.y = jumpSpeed;
			grounded = false;
			console.log("REEEEE");
